...
func setUpMocks(setStatusCmd redis.StatusCmd, getStringCmd redis.StringCmd, flushAllStatusCmd redis.StatusCmd, expireBoolCmd redis.BoolCmd) (*RedisClienterMock, *Client) {
