...
// ClientManagerMock is a mock implementation of redis.ClientManager.
//
//     func TestSomethingThatUsesClientManager(t *testing.T) {
//
//         // make and configure a mocked redis.ClientManager
...
//         }
//
//         // use mockedClientManager in code that requires redis.ClientManager
